...
const items = [
    ...
    { sku: 'CIN-B-001', nombre: 'Cinta blanca', tipo: 'Nuevo', precio: 0.25, unidad: 'metros' }
];
    ...
    try {
        ...
        for (const item of items) {
            await pool.query(`
                ...
                VALUES ($1, $2, $3, $4, $5, true, '2026-01-25')
                ON CONFLICT (sku) DO UPDATE SET precio_venta = $4, unidad = $5
            `, [item.sku, item.nombre, item.tipo, item.precio, item.unidad || 'UN']);
        }
